...
public class InteractionDbContextFactory : IDesignTimeDbContextFactory<InteractionDbContext>
{
    ...
    {
        var options = new DbContextOptionsBuilder<InteractionDbContext>();
        ...
        return new InteractionDbContext(options.Options, new DesignTimeTenantProvider(), new DesignTimeMediator());
    }
